        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('user.store') }}" method="post" class="form-vertical" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-3">
                                    <label for="nama" class="form-control-label mb-2">Nama Lengkap<span>*</span></label>
                                    <input type="text" id="nama" name="nama" placeholder="Masukkan Nama Lengkap" class="form-control @error('nama') is-invalid @enderror" >
                                    @error('nama')
                                ...
                                <div class="form-group mb-3">
                                    <label for="password" class="form-control-label mb-2">Password<span>*</span></label>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="no_hp" name="no_hp" placeholder="Masukkan No HP" class="form-control @error('no_hp') is-invalid @enderror" >
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="address" id="" cols="30" rows="10" class="form-control @error('address') is-invalid @enderror" placeholder="Masukkan Alamat Anda"></textarea>
                                    @error('address')
                                    <div class="invalid-feedback">
                                        <small class="help-block form-text text-danger">{{$message}}</small>
                                    </div>
