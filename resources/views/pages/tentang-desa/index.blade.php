                                ...
                                <tbody>
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td style="width: 25%">
                                                <img src="{{ asset('img/tentang-desa/'.$item->thumbnail) }}" alt="{{ $item->title }}" class="img-fluid w-50">
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="p-1">
                                                        <a href="{{ route('about.edit',$item->id) }}" class="btn btn-warning"><i class="ti-pencil-alt"></i></a>
                                                    </div>
                                                    <div class="p-1">
