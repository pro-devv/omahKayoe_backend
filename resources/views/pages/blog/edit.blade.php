                    ...
                    <div class="page-header float-end">
                        <div class="page-title">
                            <ol class="breadcrumb text-end">
                                ...
                                <li class=""><a href="{{ route('blog.index') }}">{{ ucwords(str_replace('-',' ',Request::segment(1))) }}</a> </li>
                        ...
                        <div class="card-body">
                            <form action="{{ route('blog.update',$data->id) }}" method="post" class="form-vertical" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ $data->title }}" placeholder="Masukkan Judul Blog" class="form-control @error('title') is-invalid @enderror"  autofocus>
                                    @error('title')
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="kategori" id="kategori">
                                                @forelse ($data_kategori as $item)
                                                    <option value="{{ $item->id }}" {{ $item->id == $data->category_blog_id ? 'selected' : '' }} >{{ ucwords($item->name_blog ) }}</option>
                                                @empty
                                ...
                                <div class="form-group mb-3">
                                    <div class="row">
                                        <div class="col" id="">
                                            <img src="{{ asset('img/blog/'.$data->thumbnail) }}" alt="{{ $data->name_product }}" srcset="" id="photosPreview">
                                        </div>
                                        <div class="col">
