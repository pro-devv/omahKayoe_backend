                        ...
                        <div class="card-body">
                            <form action="{{ route('blog.update',$data->id) }}" method="post" class="form-vertical" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ $data->title }}" placeholder="Masukkan Judul Blog" class="form-control @error('title') is-invalid @enderror" >
                                    @error('title')
                                ...
                                <div class="form-group mb-3">
                                    <div class="row">
                                        <div class="col" id="">
                                            <img src="{{ asset('img/blog/'.$data->thumbnail) }}" alt="{{ $data->title }}" srcset="" id="photosPreview">
                                        </div>
                                        <div class="col">
